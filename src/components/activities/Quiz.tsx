...
export function QuizHost({ session, updateActivity }: { session: any; updateActivity: any }) {
  ...
  return (
    <div className="p-8 h-full flex flex-col items-center max-w-4xl mx-auto w-full relative">
        ...
        <div className="w-full space-y-6">
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
             <div className="flex items-center justify-between mb-8">
                <h3 className="text-xl font-black italic">Question Results</h3>
                <div className="px-4 py-1 rounded-full bg-green-500/20 border border-green-500/50 text-green-400 text-[10px] font-black uppercase tracking-widest">
          ...
          <div className="flex justify-center pt-4">
            <Button onClick={nextQuestion} className="h-16 px-16 bg-primary text-black font-black uppercase tracking-[0.2em] rounded-2xl hover:scale-105 transition-all shadow-[0_0_30px_rgba(0,212,255,0.3)]">
...
export function QuizParticipant({ session, socket, userName }: { session: any; socket: any; userName: string }) {
  ...
  }, [state, startTime, currentQuestionIndex]);
